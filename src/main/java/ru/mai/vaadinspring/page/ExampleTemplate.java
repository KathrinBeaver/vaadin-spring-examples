 ...
 * the License.
 */
package ru.mai.vaadinspring.page;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.beans.factory.config.ConfigurableBeanFactory;
import org.springframework.context.annotation.Scope;
import ru.mai.vaadinspring.logic.LogicComponent;
import ru.mai.vaadinspring.page.ExampleTemplate.ExampleModel;
...
public class ExampleTemplate extends PolymerTemplate<ExampleModel> {
    ...
    public ExampleTemplate(@Autowired LogicComponent bean) {
        // Set the initial value to the "message" property.
        getModel().setMessage(bean.doSomethingUseful());
    }
}
